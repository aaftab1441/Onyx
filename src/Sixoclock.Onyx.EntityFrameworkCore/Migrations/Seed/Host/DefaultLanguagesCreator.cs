...
namespace Sixoclock.Onyx.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = OnyxConsts.MultiTenancyEnabled ? null : (int?)1;
            return new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "en", "English", "famfamfam-flags gb"),
                new ApplicationLanguage(tenantId, "sv", "Svenska", "famfamfam-flags se"),
        ...
        public DefaultLanguagesCreator(OnyxDbContext context)
        {
            _context = context;
        }
