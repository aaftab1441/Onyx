...
using Sixoclock.Onyx.Web.Public.Startup;
using Sixoclock.Onyx.Web.Session;

namespace Sixoclock.Onyx.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : OnyxViewComponent
    {
