...
using Sixoclock.Onyx.DemoUiComponents.Dto;

namespace Sixoclock.Onyx.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : OnyxAppServiceBase, IDemoUiComponentsAppService
    {
