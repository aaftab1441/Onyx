...
{
    public interface IMarketServicePriceParameterAppService:IApplicationService
    {
        ...
        Task<GetServicePriceParameterListOutput> GetServicePriceParameters(int marketServiceId);
