...
namespace Sixoclock.Onyx.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : OnyxServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Sixoclock.Onyx", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
