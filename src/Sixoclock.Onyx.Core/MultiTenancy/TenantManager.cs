...
using Sixoclock.Onyx.MultiTenancy.Demo;
...
namespace Sixoclock.Onyx.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(OnyxConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
