...
namespace Sixoclock.Onyx.MultiTenancy.Demo
{
    /// <summary>
    ...
    /// </summary>
    public class TenantDemoDataBuilder : OnyxServiceBase, ITransientDependency
    {
        ...
        private readonly IOcppSeedBuilder _ocppSeedBuilder;
        ...
        public TenantDemoDataBuilder(
            ...
            IAppConfigurationAccessor configurationAccessor, IOcppSeedBuilder ocppSeedBuilder)
        {
            ...
            _ocppSeedBuilder = ocppSeedBuilder;
        ...
        private async Task BuildForInternalAsync(Tenant tenant)
        {
            ...
            //Seed OCPP data
            await _ocppSeedBuilder.SeedOcppDataAsync(tenant.Id);
            //Create users
